 ...
 */
export declare function addUTMParametersToURL(url: URL | Platform.DevToolsPath.UrlString, channel?: Readonly<Platform.TypeScriptUtilities.RecursiveReadonly<Platform.TypeScriptUtilities.RecursivePartial<"stable" | "beta" | "dev" | "canary"> | undefined>>): Platform.DevToolsPath.UrlString;
/**
 ...
 * @return the `url` with the additional UTM parameters.
 */
export declare function addUTMParametersToURLIfNecessary(url: Platform.DevToolsPath.UrlString): Platform.DevToolsPath.UrlString;
